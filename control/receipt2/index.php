    ...
    <form action="" method="post">
       ...
       <div class="row">
           <div class="form-group col-md-4" style="text-align: center;">
            ...
            <button name="btn2" class="btn btn-secondary "><i class="la la-search"></i></button>
            <!-- <button class="la la-receipt"></button> -->
        ...
        <div class="form-group text-center col-md-4">
            ...
            <button id="btn" onclick="prt()" class="btn btn-danger"><i class="la la-print"></i></button>
        </div>
    ...
    <table class="table table-hover">
        ...
        <?php
         if (isset($_POST['btn'])) {
            ...
            // $ress = $conn->query($sql);
            $sql = "SELECT * FROM debit WHERE `date` BETWEEN '$start' AND '$end' WHERE `user` = '$user'";
            $ress = $conn->query($sql);
            $sn = 1;
