...
<header> 
                <div class="header">
                    ...
                    <a href="../logout.php
                    " style="color:white; margin-right:10px"><p><i class="la la-lock"></i>Logout</p></a>
                </div>
    ...
    <div class="container ">        
        <div class="table">
            <table id="myTable" class="display table  table-responsive table-border table-hover" style="color:darkblue">
                ...
                <?php
                    ...
                    $qry = " SELECT SUM(amount) As total FROM credit WHERE `user` = '$username'";
               ...
               <?php
                        $sn = 1;
                        $username = $_SESSION['username'];
                            $qry = "SELECT * FROM credit WHERE `user` = '$username'";
                            $result = $conn->query($qry);
                        ...
                        <tr>
                            ...
                            <td><?= $data['date'];?></td>
                            <td>
                                <a id="edit" href="print.php?print=<?=$data['id']; ?>"><i id="edit" class="la la-print"></i>Print</a>
                                <a id="del" href="delete.php?delete=<?=$data['id'];?>"><i id="del" class="la la-trash"></i>Delete</a>
                            </td> 
                            <?php } ?>
                        </tr>
               </tbody>
