    ...
    <div class="container">
        <div class="table ">
            <table id="myTable" class=" display table text-center table-hover  table-respnsive-md">
                <!-- <h3 class="text-center text-primary alert alert-success">sssssss</h3> -->
                    <h3 class="text-center">Total Users Deposit</h3>
                <?php
                ...
                ?>
                <p id="h33" >All Total <span>&#8358;<?=number_format($num); ?></span></p>
                <thead>
                    <tr >
                        <th id="col">S/N</th>
